...
class Pipeline_EKF:
    ...
    def NNTrain(self, n_Examples, train_input, train_target, n_CV, cv_input, cv_target):
        ...
        for ti in range(0, self.N_Epochs):
            ...
            for j in range(0, self.N_CV):
                ...
                # print ('x out',x_out_cv.size())
                # print ('t test', self.ssModel.T_test)
                # print ('y cv', y_cv.size() )
            ...
            writer.add_scalar("MSE train", self.MSE_train_dB_epoch[ti], ti)
            writer.add_scalar("MSE cv", self.MSE_cv_dB_epoch[ti], ti)
    ...
    def NNTest(self, n_Test, test_input):
        ...
        self.model = torch.load(self.modelFileName, map_location=torch.device('cpu'))
